...
public class SphereTriangles : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Sphere2 = transform.Find("Sphere 2").gameObject;
        Sphere3 = transform.Find("Sphere 3").gameObject;
        ...
        var targetZone = GameObject.CreatePrimitive(PrimitiveType.Sphere);
        targetZone.transform.position = VisualSphere;
    ...
    void Update()
    {
        ...
        //    }
        //}
        Sphere2.transform.localScale = radius * Vector3.one;
        Sphere3.transform.localScale = radius * Vector3.one;

        Sphere2.transform.localPosition = Vector3.zero - Vector3.up * radius*2;
        Sphere3.transform.localPosition = Vector3.zero - Vector3.up * radius*2;
